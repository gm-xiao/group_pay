        ...
        var c = {
            ...
            createTabDom: function() {
                ...
                if (i._parentElem = e.elem, !i.tabDomExists()) {
                    var a = ['<div class="layui-tab layui-tab-card kit-tab" lay-filter="' + i._filter + '">', '<ul class="layui-tab-title">', '<li class="layui-this" lay-id="-1"><i class="layui-icon">&#xe68e;</i> 总体概览</li>', "</ul>", '<div class="kit-tab-tool">操作&nbsp;<i class="fa fa-caret-down"></i></div>', '<div class="kit-tab-tool-body layui-anim layui-anim-upbit">', "<ul>", '<li class="kit-item" data-target="refresh"><i class="fa fa-refresh ui-icon" aria-hidden="true"></i>刷新当前</li>', '<li class="kit-item" data-target="closeCurrent"><i class="fa fa-power-off ui-icon" aria-hidden="true"></i>关闭当前</li>', '<!--<li class="kit-item" data-target="closeOther"><i class="fa fa-power-off ui-icon" aria-hidden="true"></i>关闭其他</li>-->', '<li class="kit-item" data-target="closeAll"><i class="fa fa-power-off ui-icon" aria-hidden="true"></i>关闭所有</li>', "</ul>", "</div>", '<div class="layui-tab-content">', '<div class="layui-tab-item layui-show" lay-item-id="-1"><iframe src="' + e.mainUrl + '"></iframe></div>', "</div>", "</div>"];
